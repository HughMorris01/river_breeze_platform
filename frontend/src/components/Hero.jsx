    ...
    <div className="relative min-h-svh flex items-center justify-center overflow-hidden bg-slate-900 pb-12">
      ...
      <div className="relative z-10 w-full mx-auto text-center flex flex-col items-center justify-center h-full pt-40 md:pt-48">
        ...
        <div className="max-w-6xl mx-auto px-6">
          <h1 className="text-4xl md:text-8xl font-black text-white tracking-tight mb-4 md:mb-8 drop-shadow-[0_4px_10px_rgba(0,0,0,0.8)] leading-[1.1]">
          ...
          <div className="flex flex-col w-full sm:w-auto sm:flex-row items-center justify-center gap-4 md:gap-6">
            <Link 
              to="/quote" 
              className="flex items-center justify-center w-full sm:w-auto px-8 md:px-12 py-4 md:py-6 bg-teal-500 text-white text-lg md:text-xl font-bold rounded-2xl shadow-2xl hover:bg-teal-400 hover:-translate-y-1 transition-all"
            >
              Get an Instant Quote
            </Link>
            <Link 
              to="/returning"
              className="flex items-center justify-center w-full sm:w-auto px-8 md:px-12 py-4 md:py-6 bg-white/10 backdrop-blur-md text-white text-lg md:text-xl font-bold rounded-2xl border-2 border-white/20 hover:bg-white/20 transition-all"
            >
              Returning Clients
            </Link>
          </div>
