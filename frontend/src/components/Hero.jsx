...
export default function Hero({ onGetQuote, onReturningClient }) {
  return (
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="flex flex-col w-full sm:w-auto sm:flex-row items-center justify-center gap-4 md:gap-6">
            ...
            <button 
              ...
              className="w-full sm:w-auto px-8 md:px-12 py-4 md:py-6 bg-white/10 backdrop-blur-md text-white text-lg md:text-xl font-bold rounded-2xl border-2 border-white/20 hover:bg-white/20 transition-all"
            >
              Returning Clients
            </button>
          </div>
